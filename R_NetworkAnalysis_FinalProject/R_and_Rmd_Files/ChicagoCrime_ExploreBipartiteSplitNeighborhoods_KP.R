######################################################################################################
# 
# ChicagoCrime_ExploreBipartiteSplitNeighborhoods.R
# 
# The file performs analysis on the bipartite neighborhood projections of the 
...
out_file_nonviolent = paste(path, "feb_nonviolent_neighborhoods_95_filtered.graphml", sep = "")
